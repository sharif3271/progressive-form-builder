    ...
    <div
      ...
      {showItems && (
        <div className="actions">
          ...
          <div onClick={() => onAddItem(FormItemType.MULTISELECT)} title="Add a Multi select">
            Multi-select
          </div>
          <div onClick={() => onAddItem(FormItemType.SINGLESELECT)} title="Add a Single select">
            Single-select
          </div>
          <div onClick={() => onAddItem(FormItemType.DROPDOWN)} title="Add a Dropdown">
            Dropdown
          </div>
